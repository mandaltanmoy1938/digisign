...
public class PdfSigner implements SignatureInterface {
    ...
    private static final String KEYSTORE_LOCATION = "/cert/new_cert.pfx";

//    private static final String ALIAS = "netlock teszt aláíró tanúsítvány netlock kft. azonosítója";
    private static final String ALIAS = "e48f3e80-416f-4b0b-a2f6-7ae38547b618";
...
//            throw new RuntimeException("Error while loading certificates and private key", e);
    ...
    public void signPdf(InputStream inputStream, String dest) {
        try {
            File document = new File("uns.pdf");
            FileUtils.copyInputStreamToFile(inputStream, document);
...
//            signature.setLocation("JTechLog");
            signature.setName("Tanmoy Mandal");
            signature.setReason("Test");
            signature.setLocation("CSI");
